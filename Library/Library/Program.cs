...
namespace Library
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            LibraryBook book1 = (LibraryBook)factory.CreateBook("Book", "Fernando", "Fiction", "Big S", new DateTime(1925, 4, 10));
            LibraryBook book2 = (LibraryBook)factory.CreateBook("Patterns", "Gerjan", "Fiction", "JB", new DateTime(1960, 7, 11));
            LibraryBook book3 = (LibraryBook)factory.CreateBook("Something", "Ro", "Science Fiction", "Flag", new DateTime(1949, 6, 8));
